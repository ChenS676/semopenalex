# this files takes RAW .nt file and gives RAW .nt file!
# describes which attributes to keep from entities' .nt files for embedding computation
...
def extract_triples_from_file(fn):
    with open(str("/lsdf/kit/aifb/projects/sqa/semopenalex/embeddings/02_extracted_triples_nt/" + fn),
              "w", encoding="utf-8") as g:
        with open(
                str("/lsdf/kit/aifb/projects/sqa/semopenalex/embeddings/01_raw_nt/" + fn),
            ...
            for line in f:
                ...
                if pred in pred_list:
                    ...
                    if pred == "<https://semopenalex.org/property/hasAuthor>":
                        ...
                        # length check exludes conceptscore subject relation
